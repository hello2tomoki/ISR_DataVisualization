CREATE TABLE [Stg_Rpt].[Infra_Portfolio_Overview] (
    [Infra_Private_Equity_Portfolio_Key] INT            IDENTITY (1, 1) NOT NULL,
    ...
    PRIMARY KEY CLUSTERED ([Infra_Private_Equity_Portfolio_Key] ASC)
);

CREATE TABLE [Stg_Rpt].[Liq_Total_Fund_Liquidity_Score_Tablix] (
    [Liq_Total_Fund_Liquidity_Score_Tablix_Key] INT           IDENTITY (1, 1) NOT NULL,
    ...
    PRIMARY KEY CLUSTERED ([Liq_Total_Fund_Liquidity_Score_Tablix_Key] ASC)
);
